...
const devs = ['371442093111115797','371442093111115797'];
var prefix = "!";
const adminprefix = "!"
...
client.on('message', message => {
  ...
  if(!message.guild.member(message.author).hasPermission("SEND_MESSAGES")) return message.reply("**You Don't Have ` SEND_MESSAGES` Permission**");
  if(!message.guild.member(client.user).hasPermission("SEND_MESSAGES")) return message.reply("**I Don't Have ` SEND_MESSAGES ` Permission**");
  let user = message.mentions.users.first();
  let reason = message.content.split(" ").slice(2).join(" ");
...
if(!omar.guild.member(omar.author).hasPermission("SEND_MESSAGES")) return omar.reply("**You Don't Have ` SEND_MESSAGES ` Permission**");
if(!omar.guild.member(client.user).hasPermission("SEND_MESSAGES")) return omar.reply("**I Don't Have ` SEND_MESSAGES ` Permission**");
