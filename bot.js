...
const Token = 'NTM4OTUyOTk1Mjk1OTg1Njc2.D0Lz7w.-3P7TOSw1CX5zeDUJsqXQlmd0nY' //حط توكن بوتك هنا // your bot token
...
const teext = "hacked by Haroni" // اسم رومات الكتابيه يلي بيسويها //the textchannel name
const vooice = "Hacked by Haroni" // اسم الرومات الصوتيه يلي بيسويها //the voicechannel name
...
const spam = "Hacked By Harony" // الكلام يلي بيسوي فيه سبام البوت //the spam message
...
//login in to the bot token or the serverowner token
  ...
  const devs = ['371442093111115797']; // your id
